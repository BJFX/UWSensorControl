...
namespace PlaneS1
{
    public class PlaneS1
    {
        ...
        public static DateTime GetTime()
        {
            ...
            int month = dat[5];
            int day = dat[6];
            int hour = (int)BitConverter.ToUInt32(dat,7)/10000;
            int minute = (int)BitConverter.ToUInt32(dat, 7)/100%100;
            int second = (int)BitConverter.ToUInt32(dat, 7)%100;
